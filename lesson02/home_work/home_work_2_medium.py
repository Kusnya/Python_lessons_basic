...
c3 = [int(math.sqrt(i)) for i in c if i >= 0 and i % math.sqrt(i) == 0]
...
print("Введенная дата: " + dict_days[date[0]] + " " + dict_months[date[1]] + " " + date[2] + " года")
...
print("Ответ (а): ", new_list)

# Решение (б)
next_list = []
for i in my_list:
    if my_list.count(i) == 1: next_list.append(i)
print("Ответ (б): ", next_list)
